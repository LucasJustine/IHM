...
public class CustomJTree extends JTree implements SwingWorkerInterface{
    ...
    public void addGroupe(){
        ...
        if(choix == JOptionPane.OK_OPTION){
            ...
            try{
                ...
                JOptionPane.showMessageDialog(this.getParent(),"Impossible d'ajouter un groupe.",
        ...
        if(currentPath != null){
            ...
            if(parentNode != null){
                ...
                if(((Groupe)parentNode.getUserObject()).getType() == TypeGroupe.PARTITION){
                    JOptionPane.showMessageDialog(this, "Vous ne pouvez pas retirer un sous-groupe d'un partition \nVeuillez supprimer la partition","Supprimer Groupe",JOptionPane.ERROR_MESSAGE);
                    return;
                }
                try{

                    int res = JOptionPane.showConfirmDialog(this,"Voulez vous vraiment supprimer ce groupe ?", "Supprimer Groupe",JOptionPane.YES_NO_CANCEL_OPTION);    
                    ...
                    int res = JOptionPane.showConfirmDialog(this,"Attention ce groupe contient des sous-groupes \nSupprimer ?", "Supprimer Groupe",JOptionPane.YES_NO_CANCEL_OPTION,JOptionPane.WARNING_MESSAGE);
                    if(res == JOptionPane.YES_OPTION){
    ...
    public void rename(){
        ...
        if(curPath != null){
            ...
            do {
                ...
                if(choix != JOptionPane.OK_OPTION)
                    return;
            } while(field1.getText().length() > 50);
                groupeFactory.rename(groupe, field1.getText());
    ...
    public void whenBackground() {
        try {
            ...
            JOptionPane.showMessageDialog(this.getParent(),"Impossible d'ajouter une partition.","Erreur",JOptionPane.ERROR_MESSAGE);
        }
    }
