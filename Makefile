...
JAVAC_OPTIONS = -encoding UTF8 -d build -cp build/fr:lib/flatlaf-2.6.jar:lib/mariadb-client.jar:lib/flatlaf-extras-2.6.jar:lib/svgSalamander-1.1.4.jar  -implicit:none -sourcepath src
JAVA = java
EXEC_JAR = ${JAVA} -jar
...
${BUILD}/Controller.class : ${SRC}/Controller.java \
...
${BUILD}/Init.class :	${SRC}/Init.java \
						...
						${BUILD}/controller/listeners/jlist/ListMouseListener.class \
						${BUILD}/view/admin/MoveStudentPanel.class \
						${BUILD}/view/custom/tree/CustomJTree.class \
						${BUILD}/view/etudiant/VoirChangements.class \
						${BUILD}/view/professeur/ResearchStudents.class \
						${BUILD}/view/panel/VoirGroupes.class \
						${BUILD}/controller/listeners/jlist/StudentListMouseListener.class \
...
${BUILD}/controller/listeners/comboBox/ComboxJTreeListener.class :	${SRC}/controller/listeners/comboBox/ComboxJTreeListener.java							
	${JAVAC} ${JAVAC_OPTIONS} $<

#-------------- JList ---------------------------------------------------#

${BUILD}/controller/listeners/jlist/ListMouseListener.class :	${SRC}/controller/listeners/jlist/ListMouseListener.java \
																${BUILD}/view/custom/dialog/CustomDialogEtudiant.class								
	${JAVAC} ${JAVAC_OPTIONS} $<

${BUILD}/controller/listeners/buttons/PopUpButtonListener.class :   ${SRC}/controller/listeners/buttons/PopUpButtonListener.java
	${JAVAC} ${JAVAC_OPTIONS} $<

${BUILD}/controller/listeners/jlist/StudentListMouseListener.class :	${SRC}/controller/listeners/jlist/StudentListMouseListener.java \
																		${BUILD}/view/custom/popupmenu/PopUpMenuStudent.class	
	${JAVAC} ${JAVAC_OPTIONS} $<
...
${BUILD}/controller/listeners/jtree/PopUpMenuListener.class :	${SRC}/controller/listeners/jtree/PopUpMenuListener.java \
																	${BUILD}/view/custom/popupmenu/PopUpMenu.class												
	${JAVAC} ${JAVAC_OPTIONS} $<
...
${BUILD}/controller/listeners/panel/AddStudentListener.class :	${SRC}/controller/listeners/panel/AddStudentListener.java \
...
${BUILD}/view/admin/MoveStudentPanel.class : ${SRC}/view/admin/MoveStudentPanel.java \
											...
											${BUILD}/controller/listeners/comboBox/MoveComboBoxListener.class \
											${BUILD}/view/custom/renderer/CustomListRenderer.class \
											${BUILD}/controller/listeners/comboBox/ComboxJTreeListener.class
	${JAVAC} ${JAVAC_OPTIONS} $<
...
${BUILD}/view/custom/popupmenu/PopUpMenu.class	:	${SRC}/view/custom/popupmenu/PopUpMenu.java
	${JAVAC} ${JAVAC_OPTIONS} $<	

${BUILD}/view/custom/popupmenu/PopUpMenuStudent.class	:	${SRC}/view/custom/popupmenu/PopUpMenuStudent.java \
												${BUILD}/controller/listeners/buttons/PopUpButtonListener.class
	${JAVAC} ${JAVAC_OPTIONS} $<	
...
${BUILD}/view/panel/PanelGroupe.class : ${SRC}/view/panel/PanelGroupe.java \
										...
										${BUILD}/view/custom/renderer/CustomListRenderer.class \
										${BUILD}/view/custom/tree/CustomJTree.class \
										${BUILD}/controller/listeners/jtree/PopUpMenuListener.class 
	${JAVAC} ${JAVAC_OPTIONS} $<
...
${BUILD}/view/panel/VoirGroupes.class : ${SRC}/view/panel/VoirGroupes.java \
										...
										${BUILD}/controller/listeners/panel/AddStudentListener.class \
...
${BUILD}/view/professeur/ResearchStudents.class : ${SRC}/view/professeur/ResearchStudents.java \
												${BUILD}/view/custom/renderer/CustomListRenderer.class
	${JAVAC} ${JAVAC_OPTIONS} $<
